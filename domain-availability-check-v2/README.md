...
class Way2ApiExample {
    ...
    static final String ENDPOINT = "https://app.way2api.com/api/v1/domain/availability";
...
class Program
{
    const string Endpoint = "https://app.way2api.com/api/v1/domain/availability";
...
ENDPOINT = 'https://app.way2api.com/api/v1/domain/availability'.freeze
...
const val ENDPOINT = "https://app.way2api.com/api/v1/domain/availability"
...
let endpoint = URL(string: "https://app.way2api.com/api/v1/domain/availability")!
