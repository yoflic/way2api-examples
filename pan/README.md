...
class Way2ApiExample {
    ...
    static final String ENDPOINT = "https://app.way2api.com/api/v1/pan/verify";
    ...
    public static void main(String[] args) throws Exception {
        ...
        String payload = "{\"pan_number\":\"ABCDE1234F\"}";
...
class Program
{
    const string Endpoint = "https://app.way2api.com/api/v1/pan/verify";

    static async Task<int> Main()
    {
        var apiKey = Environment.GetEnvironmentVariable("WAY2API_KEY") ?? "YOUR_API_KEY";
        var payload = "{\"pan_number\":\"ABCDE1234F\"}";
...
ENDPOINT = 'https://app.way2api.com/api/v1/pan/verify'.freeze
...
const val ENDPOINT = "https://app.way2api.com/api/v1/pan/verify"

fun main() {
    val apiKey = System.getenv("WAY2API_KEY") ?: "YOUR_API_KEY"
    val payload = "{\"pan_number\":\"ABCDE1234F\"}"
...
let endpoint = URL(string: "https://app.way2api.com/api/v1/pan/verify")!
