...
class Way2ApiExample {
    ...
    static final String ENDPOINT = "https://app.way2api.com/api/v1/upi/vpa_validation";
    ...
    public static void main(String[] args) throws Exception {
        ...
        String payload = "{\"vpa\":\"name@okhdfcbank\"}";
...
class Program
{
    const string Endpoint = "https://app.way2api.com/api/v1/upi/vpa_validation";

    static async Task<int> Main()
    {
        var apiKey = Environment.GetEnvironmentVariable("WAY2API_KEY") ?? "YOUR_API_KEY";
        var payload = "{\"vpa\":\"name@okhdfcbank\"}";
...
ENDPOINT = 'https://app.way2api.com/api/v1/upi/vpa_validation'.freeze
...
const val ENDPOINT = "https://app.way2api.com/api/v1/upi/vpa_validation"

fun main() {
    val apiKey = System.getenv("WAY2API_KEY") ?: "YOUR_API_KEY"
    val payload = "{\"vpa\":\"name@okhdfcbank\"}"
...
let endpoint = URL(string: "https://app.way2api.com/api/v1/upi/vpa_validation")!
