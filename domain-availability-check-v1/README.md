...
class Way2ApiExample {
    ...
    static final String ENDPOINT = "https://app.way2api.com/api/v1/domain/check";
    ...
    public static void main(String[] args) throws Exception {
        ...
        String payload = "{\"domain\":\"example.com\"}";
...
ENDPOINT = 'https://app.way2api.com/api/v1/domain/check'.freeze
...
const val ENDPOINT = "https://app.way2api.com/api/v1/domain/check"

fun main() {
    val apiKey = System.getenv("WAY2API_KEY") ?: "YOUR_API_KEY"
    val payload = "{\"domain\":\"example.com\"}"
