...
class Way2ApiExample {
    ...
    static final String ENDPOINT = "https://app.way2api.com/api/v1/bank/account_validation";
    ...
    public static void main(String[] args) throws Exception {
        ...
        String payload = "{\"account_number\":\"1234567890\",\"ifsc_code\":\"HDFC0001234\"}";
...
class Program
{
    const string Endpoint = "https://app.way2api.com/api/v1/bank/account_validation";

    static async Task<int> Main()
    {
        var apiKey = Environment.GetEnvironmentVariable("WAY2API_KEY") ?? "YOUR_API_KEY";
        var payload = "{\"account_number\":\"1234567890\",\"ifsc_code\":\"HDFC0001234\"}";
...
ENDPOINT = 'https://app.way2api.com/api/v1/bank/account_validation'.freeze
...
const val ENDPOINT = "https://app.way2api.com/api/v1/bank/account_validation"

fun main() {
    val apiKey = System.getenv("WAY2API_KEY") ?: "YOUR_API_KEY"
    val payload = "{\"account_number\":\"1234567890\",\"ifsc_code\":\"HDFC0001234\"}"
...
let endpoint = URL(string: "https://app.way2api.com/api/v1/bank/account_validation")!
