...
class Way2ApiExample {
    ...
    static final String ENDPOINT = "https://app.way2api.com/api/v1/rc/pdf";
...
class Program
{
    const string Endpoint = "https://app.way2api.com/api/v1/rc/pdf";
...
ENDPOINT = 'https://app.way2api.com/api/v1/rc/pdf'.freeze
...
const val ENDPOINT = "https://app.way2api.com/api/v1/rc/pdf"
...
let endpoint = URL(string: "https://app.way2api.com/api/v1/rc/pdf")!
