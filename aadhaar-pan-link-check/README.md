...
class Way2ApiExample {
    ...
    static final String ENDPOINT = "https://app.way2api.com/api/v1/aadhaar/aadhaar_pan_link_check";
    ...
    public static void main(String[] args) throws Exception {
        ...
        String payload = "{\"aadhaar_number\":\"123456789012\"}";
...
class Program
{
    const string Endpoint = "https://app.way2api.com/api/v1/aadhaar/aadhaar_pan_link_check";

    static async Task<int> Main()
    {
        var apiKey = Environment.GetEnvironmentVariable("WAY2API_KEY") ?? "YOUR_API_KEY";
        var payload = "{\"aadhaar_number\":\"123456789012\"}";
...
ENDPOINT = 'https://app.way2api.com/api/v1/aadhaar/aadhaar_pan_link_check'.freeze
...
const val ENDPOINT = "https://app.way2api.com/api/v1/aadhaar/aadhaar_pan_link_check"

fun main() {
    val apiKey = System.getenv("WAY2API_KEY") ?: "YOUR_API_KEY"
    val payload = "{\"aadhaar_number\":\"123456789012\"}"
...
let endpoint = URL(string: "https://app.way2api.com/api/v1/aadhaar/aadhaar_pan_link_check")!
