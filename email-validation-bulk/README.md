...
class Way2ApiExample {
    ...
    static final String ENDPOINT = "https://app.way2api.com/api/v1/email/validate/bulk";
    ...
    public static void main(String[] args) throws Exception {
        ...
        String payload = "{\"emails\":[\"emma.thompson@example.com\",\"not-an-email\"]}";
...
class Program
{
    const string Endpoint = "https://app.way2api.com/api/v1/email/validate/bulk";

    static async Task<int> Main()
    {
        var apiKey = Environment.GetEnvironmentVariable("WAY2API_KEY") ?? "YOUR_API_KEY";
        var payload = "{\"emails\":[\"emma.thompson@example.com\",\"not-an-email\"]}";
...
ENDPOINT = 'https://app.way2api.com/api/v1/email/validate/bulk'.freeze
...
const val ENDPOINT = "https://app.way2api.com/api/v1/email/validate/bulk"

fun main() {
    val apiKey = System.getenv("WAY2API_KEY") ?: "YOUR_API_KEY"
    val payload = "{\"emails\":[\"emma.thompson@example.com\",\"not-an-email\"]}"
...
let endpoint = URL(string: "https://app.way2api.com/api/v1/email/validate/bulk")!
