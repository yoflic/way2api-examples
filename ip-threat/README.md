...
class Way2ApiExample {
    ...
    static final String ENDPOINT = "https://app.way2api.com/api/v1/ip/threat";
...
class Program
{
    const string Endpoint = "https://app.way2api.com/api/v1/ip/threat";
...
ENDPOINT = 'https://app.way2api.com/api/v1/ip/threat'.freeze
...
const val ENDPOINT = "https://app.way2api.com/api/v1/ip/threat"
...
let endpoint = URL(string: "https://app.way2api.com/api/v1/ip/threat")!
