...
class Way2ApiExample {
    ...
    static final String ENDPOINT = "https://app.way2api.com/api/v1/rc/verify";
...
class Program
{
    const string Endpoint = "https://app.way2api.com/api/v1/rc/verify";
...
ENDPOINT = 'https://app.way2api.com/api/v1/rc/verify'.freeze
...
const val ENDPOINT = "https://app.way2api.com/api/v1/rc/verify"
...
let endpoint = URL(string: "https://app.way2api.com/api/v1/rc/verify")!
