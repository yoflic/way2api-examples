...
class Way2ApiExample {
    ...
    static final String ENDPOINT = "https://app.way2api.com/api/v1/domain/subdomains";
...
class Program
{
    const string Endpoint = "https://app.way2api.com/api/v1/domain/subdomains";
...
ENDPOINT = 'https://app.way2api.com/api/v1/domain/subdomains'.freeze
...
const val ENDPOINT = "https://app.way2api.com/api/v1/domain/subdomains"
...
let endpoint = URL(string: "https://app.way2api.com/api/v1/domain/subdomains")!
