# Credit Report Experian PDF API
...
class Way2ApiExample {
    ...
    static final String ENDPOINT = "https://app.way2api.com/api/v1/credit-report-experian/fetch-report-pdf";
...
class Program
{
    const string Endpoint = "https://app.way2api.com/api/v1/credit-report-experian/fetch-report-pdf";
...
ENDPOINT = 'https://app.way2api.com/api/v1/credit-report-experian/fetch-report-pdf'.freeze
...
const val ENDPOINT = "https://app.way2api.com/api/v1/credit-report-experian/fetch-report-pdf"
...
let endpoint = URL(string: "https://app.way2api.com/api/v1/credit-report-experian/fetch-report-pdf")!
