...
class Way2ApiExample {
    ...
    static final String ENDPOINT = "https://app.way2api.com/api/v1/domain/ssl";
    ...
    public static void main(String[] args) throws Exception {
        ...
        String payload = "{\"domain_name\":\"google.com\"}";
...
class Program
{
    const string Endpoint = "https://app.way2api.com/api/v1/domain/ssl";

    static async Task<int> Main()
    {
        var apiKey = Environment.GetEnvironmentVariable("WAY2API_KEY") ?? "YOUR_API_KEY";
        var payload = "{\"domain_name\":\"google.com\"}";
...
ENDPOINT = 'https://app.way2api.com/api/v1/domain/ssl'.freeze
...
const val ENDPOINT = "https://app.way2api.com/api/v1/domain/ssl"

fun main() {
    val apiKey = System.getenv("WAY2API_KEY") ?: "YOUR_API_KEY"
    val payload = "{\"domain_name\":\"google.com\"}"
...
let endpoint = URL(string: "https://app.way2api.com/api/v1/domain/ssl")!
