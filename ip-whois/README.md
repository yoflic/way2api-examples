...
class Way2ApiExample {
    ...
    static final String ENDPOINT = "https://app.way2api.com/api/v1/ip/whois";
...
class Program
{
    const string Endpoint = "https://app.way2api.com/api/v1/ip/whois";
...
ENDPOINT = 'https://app.way2api.com/api/v1/ip/whois'.freeze
...
const val ENDPOINT = "https://app.way2api.com/api/v1/ip/whois"
...
let endpoint = URL(string: "https://app.way2api.com/api/v1/ip/whois")!
