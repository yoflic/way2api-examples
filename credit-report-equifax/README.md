...
| | |
|---|---|
| **Endpoint** | `POST https://app.way2api.com/api/v1/credit-report/fetch` |
| **Category** | Business |
| **Coverage** | India |
| **Authentication** | `Authorization: Bearer YOUR_API_KEY` |
| **API code** | `credit_report` |
| **Full documentation** | [https://app.way2api.com/documentation/credit-report-equifax](https://app.way2api.com/documentation/credit-report-equifax) |
...
ENDPOINT = "https://app.way2api.com/api/v1/credit-report/fetch"
...
class Way2ApiExample {
    ...
    static final String ENDPOINT = "https://app.way2api.com/api/v1/credit-report/fetch";
    ...
    public static void main(String[] args) throws Exception {
        ...
        String payload = "{\"name\":\"Ananya Sharma\",\"mobile\":\"9876543210\",\"number\":\"123456789012\",\"fetch_by\":\"aadhaar\"}";
...
class Program
{
    const string Endpoint = "https://app.way2api.com/api/v1/credit-report/fetch";

    static async Task<int> Main()
    {
        var apiKey = Environment.GetEnvironmentVariable("WAY2API_KEY") ?? "YOUR_API_KEY";
        var payload = "{\"name\":\"Ananya Sharma\",\"mobile\":\"9876543210\",\"number\":\"123456789012\",\"fetch_by\":\"aadhaar\"}";
...
ENDPOINT = 'https://app.way2api.com/api/v1/credit-report/fetch'.freeze
...
let endpoint = URL(string: "https://app.way2api.com/api/v1/credit-report/fetch")!
...
The full status and error-code reference for this API is at [https://app.way2api.com/documentation/credit-report-equifax/errors](https://app.way2api.com/documentation/credit-report-equifax/errors).

## Rate limits

Limits apply per API key, per service, on a one-minute sliding window. Exceeding them returns HTTP `429` with a `Retry-After` header. Current limits for this API are published at [https://app.way2api.com/documentation/credit-report-equifax/rate-limits](https://app.way2api.com/documentation/credit-report-equifax/rate-limits).

## More

- [Full documentation](https://app.way2api.com/documentation/credit-report-equifax)
- [Request reference](https://app.way2api.com/documentation/credit-report-equifax/request)
- [Response reference](https://app.way2api.com/documentation/credit-report-equifax/response)
- [All Way2API documentation](https://app.way2api.com/documentation)

---

Part of [way2api-examples](../README.md). Slug: `credit-report-equifax`
