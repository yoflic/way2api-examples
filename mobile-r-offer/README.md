...
class Way2ApiExample {
    ...
    static final String ENDPOINT = "https://app.way2api.com/api/v1/mobile/r-offer";
...
class Program
{
    const string Endpoint = "https://app.way2api.com/api/v1/mobile/r-offer";
...
const val ENDPOINT = "https://app.way2api.com/api/v1/mobile/r-offer"
...
let endpoint = URL(string: "https://app.way2api.com/api/v1/mobile/r-offer")!
