...
class Way2ApiExample {
    ...
    static final String ENDPOINT = "https://app.way2api.com/api/v1/credit-report/pdf";
...
class Program
{
    const string Endpoint = "https://app.way2api.com/api/v1/credit-report/pdf";
...
ENDPOINT = 'https://app.way2api.com/api/v1/credit-report/pdf'.freeze
...
const val ENDPOINT = "https://app.way2api.com/api/v1/credit-report/pdf"
...
let endpoint = URL(string: "https://app.way2api.com/api/v1/credit-report/pdf")!
