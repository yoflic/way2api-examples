...
class Way2ApiExample {
    ...
    static final String ENDPOINT = "https://app.way2api.com/api/v1/voter-id/verify";
    ...
    public static void main(String[] args) throws Exception {
        ...
        String payload = "{\"voter_id\":\"ABC1234567\"}";
...
class Program
{
    const string Endpoint = "https://app.way2api.com/api/v1/voter-id/verify";

    static async Task<int> Main()
    {
        var apiKey = Environment.GetEnvironmentVariable("WAY2API_KEY") ?? "YOUR_API_KEY";
        var payload = "{\"voter_id\":\"ABC1234567\"}";
...
ENDPOINT = 'https://app.way2api.com/api/v1/voter-id/verify'.freeze
...
const val ENDPOINT = "https://app.way2api.com/api/v1/voter-id/verify"

fun main() {
    val apiKey = System.getenv("WAY2API_KEY") ?: "YOUR_API_KEY"
    val payload = "{\"voter_id\":\"ABC1234567\"}"
...
let endpoint = URL(string: "https://app.way2api.com/api/v1/voter-id/verify")!
