...
class Way2ApiExample {
    ...
    static final String ENDPOINT = "https://app.way2api.com/api/v1/domain/dns";
    ...
    public static void main(String[] args) throws Exception {
        ...
        String payload = "{\"domain_name\":\"google.com\",\"record_type\":\"all\"}";
...
class Program
{
    const string Endpoint = "https://app.way2api.com/api/v1/domain/dns";

    static async Task<int> Main()
    {
        var apiKey = Environment.GetEnvironmentVariable("WAY2API_KEY") ?? "YOUR_API_KEY";
        var payload = "{\"domain_name\":\"google.com\",\"record_type\":\"all\"}";
...
ENDPOINT = 'https://app.way2api.com/api/v1/domain/dns'.freeze
...
const val ENDPOINT = "https://app.way2api.com/api/v1/domain/dns"

fun main() {
    val apiKey = System.getenv("WAY2API_KEY") ?: "YOUR_API_KEY"
    val payload = "{\"domain_name\":\"google.com\",\"record_type\":\"all\"}"
...
let endpoint = URL(string: "https://app.way2api.com/api/v1/domain/dns")!
