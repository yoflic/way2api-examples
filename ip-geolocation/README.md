...
class Way2ApiExample {
    ...
    static final String ENDPOINT = "https://app.way2api.com/api/v1/ip/geolocation";
...
class Program
{
    const string Endpoint = "https://app.way2api.com/api/v1/ip/geolocation";
...
ENDPOINT = 'https://app.way2api.com/api/v1/ip/geolocation'.freeze
...
const val ENDPOINT = "https://app.way2api.com/api/v1/ip/geolocation"
...
let endpoint = URL(string: "https://app.way2api.com/api/v1/ip/geolocation")!
